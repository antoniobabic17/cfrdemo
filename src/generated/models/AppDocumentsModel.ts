...
export interface AppDocumentsBase {
  ID?: number;
  Title?: string;
  Modified?: string;
...
export interface AppDocumentsRead extends AppDocumentsBase {
  Editor?: EditorValue;
...
export interface AppDocumentsWrite extends AppDocumentsBase {
  Editor?: EditorValue;
  UploadedBy?: UploadedByValue;
  Author?: AuthorValue;
  CheckoutUser?: CheckoutUserValue;
